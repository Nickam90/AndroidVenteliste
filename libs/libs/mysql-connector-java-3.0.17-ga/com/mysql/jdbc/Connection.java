...
public class Connection implements java.sql.Connection {
    ...
    Connection(String host, int port, Properties info, String database,
        String url, NonRegisteringDriver d) throws SQLException {
        if (Driver.TRACE) {
    ...
    public CallableStatement prepareCall(String sql)
        ...
        if (this.getUseUltraDevWorkAround()) {
            ...
            throw new SQLException("Callable statments not "
                + "supported.", "S1C00");
        }
    }
    ...
    ResultSet execSQL(String sql, int maxRows, Buffer packet,
        int resultSetType, String catalog) throws SQLException {
    ...
    class UltraDevWorkAround implements CallableStatement {
        ...
        public BigDecimal getBigDecimal(int p1)
            throws SQLException {
            throw new SQLException("Not supported");
        }
        ...
        public void setClob(int p1, final Clob p2)
            throws SQLException {
        ...
        public void setCursorName(String p1)
            throws SQLException {
            throw new SQLException("Not supported");
        }
        ...
        public void setRef(int p1, final Ref p2)
            throws SQLException {
            throw new SQLException("Not supported");
        }
